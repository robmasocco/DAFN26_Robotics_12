...
\end{lstlisting}
	\end{columns}
	Refer to the \href{https://docs.docker.com/compose/compose-file/}{\color{blue}\underline{Compose reference}} for more information.
\end{frame}
...
\begin{frame}{Example}{\texttt{ros2-examples}}
  ...
  It also supports the \textbg{automated build} of \textbg{development containers} in \textbg{VS Code}.\\
	Such containers are based on our \href{https://github.com/dotX-Automation/dua-template}{\color{blue}{\underline{\textbf{Distributed Unified Architecture}}}} project.\\
  \bigskip
